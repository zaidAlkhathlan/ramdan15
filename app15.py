...
def can_show_riddle():
    ...
    start_time = now.replace(hour=16, minute=55, second=0, microsecond=0)  
    end_time = now.replace(hour=16, minute=59, second=0, microsecond=0)  
...
RIDDLE = {
    "question": "اي من هذه الدول ليست جزاء من الدول الاسكندنافية؟",
    "options": ["الدنمارك", "فنلندا", "السويد", "النرويج"],
    "answer": "فنلندا"
}
