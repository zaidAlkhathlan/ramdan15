...
def can_show_riddle():
    ...
    start_time = now.replace(hour=18, minute=41, second=0, microsecond=0)  
    end_time = now.replace(hour=18, minute=46, second=0, microsecond=0)  
...
RIDDLE = {
    "question": "من هو مؤسس علم الوراثة الحديث؟ ",
    "options": ["فرانسيسكو ريدي", "جريجور مندل", "تشارلز داروين", "آلان تورنج"],
    "answer": "جريجور مندل"
}
