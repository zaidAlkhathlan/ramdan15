...
def can_show_riddle():
    ...
    start_time = now.replace(hour=19, minute=25, second=0, microsecond=0)  
...
##############################
RIDDLES = [
    {"question": "ما هو الطير الذي يمتلك أكبر جناحين؟", "options": ["اللقلق", "البجع", "الكوندور", "القطرس"], "answer": "القطرس"},
]
